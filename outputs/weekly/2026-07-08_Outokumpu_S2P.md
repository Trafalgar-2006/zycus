...
| View | Signal | Verdict |
|------|--------|---------|​
| **Naïve (% complete vs time)** | 7% tasks done; 59% of schedule elapsed | Behind — 7% done, 59% of time elapsed (51pp gap) |
| **This agent — RAG + ML** | Score 0.367; 0/15 critical-path tasks Red | **Amber** |
| **This agent — Monte Carlo** | 10,000 simulations, historical duration ratios from completed tasks | P(on-time) = 78% |
