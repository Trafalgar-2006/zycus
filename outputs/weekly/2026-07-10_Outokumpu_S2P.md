...
Monte Carlo simulation (n=10,000) gives **76%** probability of finishing by 2026-12-07. 
...
| View | Signal | Verdict |
|------|--------|---------|​
| **Naïve (% complete vs time)** | 7% tasks done; 59% of schedule elapsed | Behind — 7% done, 59% of time elapsed (52pp gap) |
| **This agent — RAG + ML** | Score 0.367; 0/15 critical-path tasks Red | **Amber** |
| **This agent — Monte Carlo** | 10,000 simulations, historical duration ratios from completed tasks | P(on-time) = 76% |

> *The naïve view ignores velocity trends, critical-path composition, and duration variance. The agent's MC uses historical slip rates from completed tasks — producing a calibrated probability rather than a binary on/off.*
